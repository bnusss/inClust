...
print(x_train)
print(batch_information_data)
print(label_information_data)
...
x_recon = Dense(input_size, activation=activation_function)(h)
...
Training = training
if Training == 'T':
    vae.fit([x_train, batch_information_data, label_information_data],
            shuffle=True,
            epochs=epochs,
